...
function safeScene () {
    ...
    portal = sprites.create(img`
        ...
        . . f a 8 a a a a a 8 a f . . . 
        . f f a 8 a 8 8 8 a 8 a f f . . 
        . f a a 8 a 8 a 8 a 8 a a f . . 
        . f a 8 a 8 a 8 a 8 a 8 a f . . 
        . f a 8 a 8 a 8 a 8 a 8 a f . . 
        . f a 8 a 8 a 8 a 8 a 8 a f . . 
        . f a 8 a 8 a a a 8 a 8 a f . . 
        . f a a 8 a 8 8 8 a 8 a a f . . 
        . f f a 8 a a a a a 8 a f f . . 
        . . f a a 8 8 8 8 8 a a f . . . 
        . . f f a a a a a a a f f . . . 
        . . . f f f f f f f f f . . . . 
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Portal)
    portal.setPosition(135, 110)
...
hero = sprites.create(img`
    ...
    . . . . . f f . . f f . . . . . 
    `, SpriteKind.Player)
controller.moveSprite(hero, 75, 0)
hero.setPosition(100, 110)
hero.setStayInScreen(true)
hero.ay = 120
game.splash("Hello traveler")
game.splash("You must defeat enemies")
game.splash("To rank up")
canAttack = false
swordOut = false
info.setLife(3)
